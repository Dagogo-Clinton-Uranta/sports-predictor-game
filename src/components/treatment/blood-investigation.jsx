      ...
      {selectedPatient && (
        <Grid container spacing={1} sx={{ minWidth: 100 }}>
          ...
          <div style={{ width: '100%', margin: '20px' }}>
            ...
            <br/>
            <div style={{padding: '10px', border: state.bloodInv1 ? '1px solid #00000033' : ''}}>
             {state.bloodInv1 &&  <Chip label={state.bloodInv1} onClick={handleClick} onDelete={handleDelete1} />}
             {state.bloodInv2 && <> &nbsp; 
              <Chip label={state.bloodInv2} onClick={handleClick} onDelete={handleDelete2} /></>}
            </div>
