...
} from 'src/redux/actions/tournamentWest.action';
...
export default function NCAAWestPage() {
...
console.log("OUR COMPETITOR RANGE in FOCUS IS--->",competitorRangeInFocus)
...
const movetoFinal  =() =>{
 ...
 const callThirtyTwoWest2 = (entry)=>{ dispatch(setThirtyTwoWest2(entry))}
 const callThirtyTwoWest3 = (entry)=>{ dispatch(setThirtyTwoWest3(entry))}
 const callThirtyTwoWest4 = (entry)=>{ dispatch(setThirtyTwoWest4(entry))}
 const callThirtyTwoWest5 = (entry)=>{ dispatch(setThirtyTwoWest5(entry))}
 const callThirtyTwoWest6 = (entry)=>{ dispatch(setThirtyTwoWest6(entry))}
 const callThirtyTwoWest7 = (entry)=>{ dispatch(setThirtyTwoWest7(entry))}
 const callThirtyTwoWest8 = (entry)=>{ dispatch(setThirtyTwoWest8(entry))}
 
 const callSixteenWest1 = (entry)=>{ dispatch(setSixteenWest1(entry))}
 const callSixteenWest2 = (entry)=>{ dispatch(setSixteenWest2(entry))}
 const callSixteenWest3 = (entry)=>{ dispatch(setSixteenWest3(entry))}
 const callSixteenWest4 = (entry)=>{ dispatch(setSixteenWest4(entry))}
 
 const callEightWest1 = (entry)=>{ dispatch(setEightWest1(entry))}
...
<Divider style={{width:"100%",position:"relative",top:"2rem"}}/>
    ...
    <RespScale style={{display:"flex",flexDirection:"row-reverse",justifyContent:"space-between",gap:"0.5rem",alignItems:"center",width:"100%"}}>
              <div style={{display:"flex",justifyContent:"center",alignItems:"center",textAlign:"center",color:"white",backgroundColor:"#260448", height:"2.5rem",width:"6.5rem",borderRadius:"5%",marginLeft:"1rem"}} >
              R64
...
<RespScale style={{display:"flex",flexDirection:"column",flex:"1",justifyContent:"space-around",alignItems:"center",height:"100%",fontSize:"12px"}}>  
                ...
                <div style={{display:"flex",flexDirection:"column",gap:"2.5rem"}}>
                  ...
                  <div>
                   <div onClick={()=>{callThirtyTwoWest1(competitorRangeInFocus && competitorRangeInFocus[0] &&  competitorRangeInFocus[0].name)}}
                   ...
                   <div onClick={()=>{callThirtyTwoWest1(competitorRangeInFocus && competitorRangeInFocus[15] &&  competitorRangeInFocus[15].name)}}
                 ...
                 <div>
                   <div  onClick={()=>{callThirtyTwoWest2(competitorRangeInFocus && competitorRangeInFocus[7] &&  competitorRangeInFocus[7].name)}}
                   ...
                   <div onClick={()=>{callThirtyTwoWest2(competitorRangeInFocus && competitorRangeInFocus[8] &&  competitorRangeInFocus[8].name)}}
                 ...
                 <div> 
                    <div onClick={()=>{callThirtyTwoWest3(competitorRangeInFocus && competitorRangeInFocus[4] &&  competitorRangeInFocus[4].name)}}
                    ...
                    <div onClick={()=>{callThirtyTwoWest3(competitorRangeInFocus && competitorRangeInFocus[11] &&  competitorRangeInFocus[11].name)}}
                 ...
                 <div>
                     <div onClick={()=>{callThirtyTwoWest4(competitorRangeInFocus && competitorRangeInFocus[3] &&  competitorRangeInFocus[3].name)}}
                     ...
                     <div onClick={()=>{callThirtyTwoWest4(competitorRangeInFocus && competitorRangeInFocus[12] &&  competitorRangeInFocus[12].name)}}
                ...
                <div  style={{display:"flex",flexDirection:"column",gap:"2.5rem"}}>
                 ...
                 <div>
                     <div onClick={()=>{callThirtyTwoWest5(competitorRangeInFocus && competitorRangeInFocus[5] &&  competitorRangeInFocus[5].name)}}
                     ...
                     <div onClick={()=>{callThirtyTwoWest5(competitorRangeInFocus && competitorRangeInFocus[10] &&  competitorRangeInFocus[10].name)}}
                 ...
                 <div>
                   <div onClick={()=>{callThirtyTwoWest6(competitorRangeInFocus && competitorRangeInFocus[2] &&  competitorRangeInFocus[2].name)}}
                   ...
                   <div onClick={()=>{callThirtyTwoWest6(competitorRangeInFocus && competitorRangeInFocus[13] &&  competitorRangeInFocus[13].name)}}
                ...
                <div>
                   <div onClick={()=>{callThirtyTwoWest7(competitorRangeInFocus && competitorRangeInFocus[6] &&  competitorRangeInFocus[6].name)}}
                   ...
                   <div onClick={()=>{callThirtyTwoWest7(competitorRangeInFocus && competitorRangeInFocus[9] &&  competitorRangeInFocus[9].name)}}
                ...
                <div>
                   <div onClick={()=>{callThirtyTwoWest8(competitorRangeInFocus && competitorRangeInFocus[1] &&  competitorRangeInFocus[1].name)}}
                   ...
                   <div onClick={()=>{callThirtyTwoWest8(competitorRangeInFocus && competitorRangeInFocus[14] &&  competitorRangeInFocus[14].name)}}
      ...
      <RespScale style={{display:"flex",flex:"1",justifyContent:"space-evenly",flexDirection:"column",alignItems:"center",height:"100%",fontSize:"12px",}}> 
               ...
               <div onClick={()=>{callSixteenWest1(thirtyTwoWest1)}}
               
               style={{cursor:"pointer",color:"white",backgroundColor:competitorRangeInFocus && competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[0] &&competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[0].roundTwo === "lost"?"grey":"#260448", height:"3rem",width:"7rem",marginBottom:"0.5rem",borderRadius:"5%",position:"relative",top:"-1rem",display:"flex",alignItems:"center",justifyContent:"center"}} >
               ...
               {thirtyTwoWest1}
                ...
                <div onClick={()=>{callSixteenWest1(thirtyTwoWest2)}}
                 style={{cursor:"pointer",color:"white",backgroundColor:competitorRangeInFocus && competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[1] &&competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[1].roundTwo === "lost"?"grey":"#260448", height:"3rem",width:"7rem",marginTop:"0.5rem",marginBottom:"0.5rem",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"5%",position:"relative",top:"-1.5rem"}} >
                ...
                <div  onClick={()=>{callSixteenWest2(thirtyTwoWest3)}}
                style={{cursor:"pointer",color:"white",backgroundColor:competitorRangeInFocus && competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[2] &&competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[2].roundTwo === "lost"?"grey":"#260448", height:"3rem",width:"7rem",marginTop:"0.5rem",marginBottom:"0.5rem",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"5%"}} >
                ...
                <div onClick={()=>{callSixteenWest2(thirtyTwoWest4)}}
                 style={{cursor:"pointer",color:"white",backgroundColor:competitorRangeInFocus && competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[3] &&competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[3].roundTwo === "lost"?"grey":"#260448", height:"3rem",width:"7rem",marginTop:"0.5rem",marginBottom:"0.5rem",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"5%",position:"relative",top:"-1rem"}} >
                ...
                <div onClick={()=>{callSixteenWest3(thirtyTwoWest5)}}
                 style={{cursor:"pointer",color:"white",backgroundColor:competitorRangeInFocus && competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[4] &&competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[4].roundTwo === "lost"?"grey":"#260448", height:"3rem",width:"7rem",marginTop:"0.5rem",marginBottom:"0.5rem",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"5%",position:"relative",top:"1rem"}} >
                ...
                <div  onClick={()=>{callSixteenWest3(thirtyTwoWest6)}}
                 style={{cursor:"pointer",color:"white",backgroundColor:competitorRangeInFocus && competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[5] &&competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[5].roundTwo === "lost"?"grey":"#260448", height:"3rem",width:"7rem",marginTop:"0.5rem",marginBottom:"0.5rem",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"5%"}} >
                ...
                <div  onClick={()=>{callSixteenWest4(thirtyTwoWest7)}}
                style={{cursor:"pointer",color:"white",backgroundColor:competitorRangeInFocus && competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[6] &&competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[6].roundTwo === "lost"?"grey":"#260448", height:"3rem",width:"7rem",marginTop:"0.5rem",marginBottom:"0.5rem",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"5%",position:"relative",top:"1.5rem"}} >
                ...
                <div  onClick={()=>{callSixteenWest4(thirtyTwoWest8)}}
                style={{cursor:"pointer",color:"white",backgroundColor:competitorRangeInFocus && competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[7] &&competitorRangeInFocus.filter((item)=>(item.roundOne && item.roundOne === 'won'))[7].roundTwo === "lost"?"grey":"#260448", height:"3rem",width:"7rem",marginTop:"0.5rem",marginBottom:"0.5rem",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"5%",position:"relative",top:"1rem"}} >
    ...
    <RespScale style={{display:"flex",flex:"1",justifyContent:"space-evenly",flexDirection:"column",alignItems:"center",height:"100%",fontSize:"12px",}}> 
               ...
               <div onClick={()=>{callEightWest1(sixteenWest1)}}
               ...
               <div onClick={()=>{callEightWest1(sixteenWest2)}}
               ...
               {sixteenWest2}
                ...
                <div onClick={()=>{callEightWest2(sixteenWest3)}}
               ...
               <div onClick={()=>{callEightWest2(sixteenWest4)}}
           ...
           <RespScale style={{display:"flex",flex:"1",justifyContent:"space-evenly",flexDirection:"column",alignItems:"center",height:"100%",fontSize:"12px",}}>  
              ...
              <div onClick={()=>{callFourWest1(eightWest1)}}
              ...
              <div onClick={()=>{callFourWest1(eightWest2)}}
...
<h4 style={{marginTop:"0rem"}}>March Madness</h4>
 ...
 <Typography variant="h6" sx={{ textAlign: 'left',cursor:"pointer"}}>
  ...
  <div style={{backgroundColor:'#F4F4F4', height:"2rem",color:"#260448",fontWeight:"bolder",display:"flex",justifyContent:"center",alignItems:"center"}}> WEST PREDICTIONS</div>
