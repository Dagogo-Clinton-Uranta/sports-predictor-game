...
export default function FootballCleanSheetResultsPage() {
...
<div style={{display:"flex", justifyContent:"space-between"}}>
  <Typography  onClick={()=>{navigate('/dashboard/football-cleansheet')}}  variant="h6" sx={{ textAlign: 'left', mb: 2,color:"lightgrey",cursor:"pointer",}}>
      PREDICT
    </Typography>
