...
<RespScale style={{display:"flex",flexDirection:"column",flex:"1",justifyContent:"space-around",alignItems:"center",height:"100%",fontSize:"12px"}}>  
                ...
                <div style={{display:"flex",flexDirection:"column",gap:"2.5rem"}}>
                  ...
                  <div>
                   ...
                   <div onClick={()=>{callThirtyTwoEast1(competitorRangeInFocus && competitorRangeInFocus[1] &&  competitorRangeInFocus[1].name)}}
                 ...
                 <div>
                   <div  onClick={()=>{callThirtyTwoEast2(competitorRangeInFocus && competitorRangeInFocus[2] &&  competitorRangeInFocus[2].name)}}
                   ...
                   <div onClick={()=>{callThirtyTwoEast2(competitorRangeInFocus && competitorRangeInFocus[3] &&  competitorRangeInFocus[3].name)}}
                 ...
                 <div> 
                    ...
                    <div onClick={()=>{callThirtyTwoEast3(competitorRangeInFocus && competitorRangeInFocus[5] &&  competitorRangeInFocus[5].name)}}
                 ...
                 <div>
                     <div onClick={()=>{callThirtyTwoEast4(competitorRangeInFocus && competitorRangeInFocus[6] &&  competitorRangeInFocus[6].name)}}
                     ...
                     <div onClick={()=>{callThirtyTwoEast4(competitorRangeInFocus && competitorRangeInFocus[7] &&  competitorRangeInFocus[7].name)}}
                ...
                <div  style={{display:"flex",flexDirection:"column",gap:"2.5rem"}}>
                 ...
                 <div>
                     <div onClick={()=>{callThirtyTwoEast5(competitorRangeInFocus && competitorRangeInFocus[8] &&  competitorRangeInFocus[8].name)}}
                     ...
                     <div onClick={()=>{callThirtyTwoEast5(competitorRangeInFocus && competitorRangeInFocus[9] &&  competitorRangeInFocus[9].name)}}
                 ...
                 <div>
                   <div onClick={()=>{callThirtyTwoEast6(competitorRangeInFocus && competitorRangeInFocus[10] &&  competitorRangeInFocus[10].name)}}
                   ...
                   <div onClick={()=>{callThirtyTwoEast6(competitorRangeInFocus && competitorRangeInFocus[11] &&  competitorRangeInFocus[11].name)}}
                ...
                <div>
                   <div onClick={()=>{callThirtyTwoEast7(competitorRangeInFocus && competitorRangeInFocus[12] &&  competitorRangeInFocus[12].name)}}
                   ...
                   <div onClick={()=>{callThirtyTwoEast7(competitorRangeInFocus && competitorRangeInFocus[13] &&  competitorRangeInFocus[13].name)}}
                ...
                <div>
                   ...
                   <div onClick={()=>{callThirtyTwoEast8(competitorRangeInFocus && competitorRangeInFocus[15] &&  competitorRangeInFocus[15].name)}}
