...
export default function NFLRushingYardsPage() {
...
<Container  style={{display: 'flex', justifyContent: 'center',alignItems:"center",flex:4, border: '1px solid #0000001A',  marginTop: '2%', marginBottom: '2%', borderRadius: '15px',backgroundColor:"#FAFAFA" }}>
    <StyledContent>
     ...
     <div style={{display:"flex", justifyContent:"space-between"}}>
      <Typography variant="h6" onClick={()=>{navigate('/dashboard/football-goalscorers')}} sx={{ textAlign: 'left',cursor:"pointer",color:"lightgray", mb: 2}}>
          Football
        </Typography>

        <Typography variant="h6" sx={{ textAlign: 'left',cursor:"pointer", mb: 2}}>
          NFL
        </Typography>
    </div>
        <Divider/>
...
<Container   style={{display: 'flex',flexDirection:"column", justifyContent: 'space-between',flex:2, border: '1px solid #0000001A',   marginTop: '2%', marginBottom: '2%', borderRadius: '15px',backgroundColor:"#FAFAFA" }}>
    ...
    <div style={{display:"flex", justifyContent:"space-between"}}>
      <Typography   variant="h6" sx={{ textAlign: 'left',cursor:"pointer", mb: 2}}>
        ...
        <Typography onClick={()=>{navigate('/dashboard/nfl-rushyards-results')}} variant="h6" sx={{ textAlign: 'left',cursor:"pointer", mb: 2,color:"lightgrey"}} >
          RESULTS
        </Typography>
    </div>
        <Divider/>
